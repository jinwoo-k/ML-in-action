...
# classifierArray = adaBoostTrainDS(dataMat, classLabels, 9)
# print
# result = adaClassify([[0, 0], [1, 1]], classifierArray[0])
# print(result)

# dataArr, labelArr = loadDataSet('horseColicTraining2.txt')
# classifyArr = adaBoostTrainDS(dataArr, labelArr, 10)
# testArr, testLabelArr = loadDataSet('horseColicTest2.txt')
# prediction10 = adaClassify(testArr, classifyArr[0])
# errArr = mat(ones((len(testArr), 1)))
# err = errArr[prediction10 != mat(testLabelArr).T].sum()
# print err / len(testArr) * 100
