...
# print(scanD(dataSet, c1, 0.7))  # ([frozenset([3]), frozenset([2]), frozenset([5])], {frozenset([4]): 0.25, frozenset([5]): 0.75, frozenset([2]): 0.75, frozenset([3]): 0.75, frozenset([1]): 0.5})
...
# print aprioriGen(map(frozenset, [[0,1], [0,2], [2,0], [2,1]]), 3)
...
# L2 -> freqSet : frozenset([2,5]), H : [frozenset([2]), frozenset([5])]
# L3 -> freqSet : frozenset([2,3,5]), H : [frozenset([2,3]), frozenset([2,5]),frozenset([3,5])]
